...
This repository contains a Playwright UI test written in TypeScript and is configured to run tests in different environments such as Development, Stage, and Production.
...
1. **Clone the Repository**: Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/triosoftinc/trio-Business-QAFrontend.git
   ```
...
- **Multiple Environment Support:** Supports DEV, STG, and PROD environments with separate test data.
